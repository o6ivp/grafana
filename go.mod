...
require (
	...
	github.com/aws/aws-sdk-go-v2/service/cloudwatch v1.56.1 // @grafana/data-sources-plugins
	github.com/aws/aws-sdk-go-v2/service/cloudwatchlogs v1.69.0 // @grafana/data-sources-plugins
